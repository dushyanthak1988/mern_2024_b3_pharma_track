                  ...
                  <tbody>
                    <tr>
                      <td className="product-thumbnail">
                        <img src= {product02} alt="Image" className="img-fluid" />
                      </td>
                    ...
                    <tr>
                      <td className="product-thumbnail">
                        <img src= {product01} alt="Image" className="img-fluid" />
                      </td>
                      <td className="product-name">
            ...
            <div className="col-md-6 pl-5">
              <div className="row justify-content-end">
                <div className="col-md-7">
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <button className="btn btn-primary btn-lg btn-block" onClick={() => window.location='/checkout'}>
                        Proceed To Checkout
                      </button>
                    </div>
                  </div>
