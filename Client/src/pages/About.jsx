...
import person1Image from '../assets/images/person_1.jpg';
import person2Image from '../assets/images/person_2.jpg';
import person3Image from '../assets/images/person_3.jpg';
import person4Image from '../assets/images/person_4.jpg';

const About = () => {
  return (
    <div>
      <div className="site-blocks-cover inner-page" style={{ backgroundImage: `url(${heroImage})` }}>
        <div className="container">
          <div className="row">
            <div className="col-lg-7 mx-auto align-self-center">
              <div className="text-center">
                <h1>About Us</h1>
                <p>about us display</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
              ...
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <img src={person1Image} alt="Image placeholder" className="mb-4" />
                    <h3 className="block-38-heading h4">Dushyantha kalehewatte </h3>
            ...
            <div className="col-md-6 col-lg-6 mb-5">
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <img src={person2Image} alt="Image placeholder" className="mb-4" />
                    <h3 className="block-38-heading h4"> varuna lakshan</h3>
            ...
            <div className="col-md-6 col-lg-6 mb-5">
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <img src={person3Image} alt="Image placeholder" className="mb-4" />
                    <h3 className="block-38-heading h4">pudasari kalehewatte</h3>
            ...
            <div className="col-md-6 col-lg-6 mb-5">
              <div className="block-38 text-center">
                <div className="block-38-img">
                  <div className="block-38-header">
                    <img src={person4Image} alt="Image placeholder" className="mb-4" />
                    <h3 className="block-38-heading h4">kasuni kalehewatte</h3>
